...
<main>
  ...
  <div class="breadcrumb">
    <div>
      <p>
        <a href="/">TOP</a> 〉
        <a href="/mansions">マンション検索</a> 〉
        <a href="/mansions">マンション情報一覧</a> 〉
        <a href="/mansions/<?= $mansion->id ?>"><?= $mansion->title ?></a>
      </p>
    </div>
  </div>
  <section class="mansion-info">
    <h3 class="section-h3"><?= $mansion->title ?></h3>
    <div class="flexbox">
      <div class="appraisal">
        <div>
          <h4>概算査定金額</h4>
          <p>
            ...
            <span class="number"><?= $mansion->unit_price ?></span>
    ...
    <div class="mansion-detail">
      <dl>
        <div class="detail-row">
          <dt><span>所在地</span></dt>
          <dd><?= $mansion->address ?></dd>
        </div>
        <div class="detail-row">
          <dt><span>交通</span></dt>
          <dd><?= $mansion->access ?></dd>
        </div>
        <div class="detail-row">
          <dt><span>総戸数</span></dt>
          <dd class="half"><?= $mansion->get("total_units", "ーーー", "戸") ?></dd>
          <dt><span>築年数</span></dt>
          <dd class="half">
        ...
        <div class="detail-row">
          <dt><span>階数</span></dt>
          <dd class="half"><?= $mansion->get("floors", "ーーー") ?></dd>
          <dt><span>建築構造</span></dt>
          <dd class="half"><?= $mansion->get("architecture", "ーーー") ?></dd>
        </div>
        <div class="detail-row">
          <dt><span>備考</span></dt>
          <dd><p><?= $mansion->get("note", "ーーー") ?></p></dd>
        </div>
      </dl>
    </div>
